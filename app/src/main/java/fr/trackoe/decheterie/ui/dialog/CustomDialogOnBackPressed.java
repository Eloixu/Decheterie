...
public class CustomDialogOnBackPressed extends Dialog {
    public CustomDialogOnBackPressed(Context context) {
        super(context);
    }

    public CustomDialogOnBackPressed(Context context, int theme) {
        super(context, theme);
    }
